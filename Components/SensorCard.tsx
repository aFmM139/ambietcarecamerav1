    ...
    <View className="self-stretch bg-[#1A1A1A] border border-[#2C2C2C] rounded-xl p-2 items-center gap-1">
      ...
      <View className="flex-row items-center justify-around w-full">
        ...
        <View className="items-center gap-[2px]">
          ...
          <Text className="text-[#9E9E9E] text-[10px]">Humedad</Text>
        ...
        <View className="items-center gap-[2px]">
          ...
          <Text className="text-[#9E9E9E] text-[10px]">Temp.</Text>
          <Text className="text-[#81C784] text-base font-extrabold">
            {data.error
              ? "—"
      ...
      {/* Error */}
      {data.error && (
        <Text className="text-[#EF5350] text-[10px] text-center">
          Sin señal
        </Text>
      )}
    </View>
  ...
  return (
    <View className="self-stretch bg-[#1A1A1A] border border-[#2C2C2C] rounded-xl p-2 items-center gap-1">
      ...
      <View className="items-center gap-[2px]">
        ...
        <Text className="text-[#9E9E9E] text-[10px]">MQ-135</Text>
        <Text className="text-[#81C784] text-base font-extrabold">
          {data.error
            ? "—"
            : data.ppm !== null
