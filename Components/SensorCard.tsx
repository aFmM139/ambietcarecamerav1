...
export function DHTCard({ titulo, data }: { titulo: string; data: DHTData }) {
  return (
    <View className="self-stretch bg-[#1A1A1A] border border-[#2C2C2C] rounded-xl p-1 items-center gap-1">
      ...
      <View className="flex-row items-center justify-around w-full">
        <View className="items-center gap-[2px]">
          ...
          <Text className="text-[#9E9E9E] text-[10px] font-semibold">Humedad</Text>
        ...
        <View className="items-center gap-[2px]">
          ...
          <Text className="text-[#9E9E9E] text-[10px] font-semibold">Temp.</Text>
          <Text className="text-[#81C784] text-base font-extrabold">
      ...
      {data.error && (
        <Text className="text-[#EF5350] text-[10px] tracking-[1px] text-center">Sin señal</Text>
      )}
    </View>
  );
}
...
export function AirCard({ data }: { data: AirData }) {
  return (
    <View className="self-stretch bg-[#1A1A1A] border border-[#2C2C2C] rounded-xl p-2 items-center gap-1">
      <Text className="text-[#9E9E9E] text-[10px] font-bold tracking-[2px] uppercase self-start">
        CALIDAD DE AIRE
      </Text>
      <View className="flex-row items-center justify-center w-full">
        <View className="items-center gap-[2px]">
          ...
          <Text className="text-[#9E9E9E] text-[10px] font-semibold">MQ-135</Text>
          <Text className="text-[#81C784] text-base font-extrabold">
